<template>
  <Head :title="language.receipts_from_delegates" />

  <div>
    <page-header>
      <span> {{ language.receipts_from_delegates }} - {{ groupe.name }} </span>
    </page-header>
                  ...
                  >
                    <td class="border-t">
                      <Link
                        ...
                        :href="route('reimbursements.empReimbursements', employee.id)"
                      >
                        {{ ++i }}
                      </Link>
                    </td>
