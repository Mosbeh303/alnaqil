  ...
  <div>
    ...
    <page-header>
      <div class="flex justify-between">
        <div>{{ language.modify_employee_account }} ({{ employee.name }})</div>
        <div>
          <BackButton />
        </div>
      </div>
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        groupe: this.employee.groupe_id,
        username: this.employee.username,
        email: this.employee.email,
        phone: this.employee.phone,
        city: this.employee.city_id,
        branch: this.employee.branch_id,
  ...
  methods: {
    ...
    submitUpdatePassword() {
      this.formUpdatePassword.post(
        this.route("employee.update_password", this.employee),
        {
          preserveScroll: true,
          onError: () => this.form.reset(),
        }
