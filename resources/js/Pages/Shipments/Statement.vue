<template>
    <Head :title="language.Accounting_shipment_statement" />

    <div>
        <page-header>{{ language.Accounting_shipment_statement }}</page-header>
        ...
        <Section title="" class="md:m-7 m-4">
            <form @submit.prevent="submit">
                ...
                <Label :value="language.optional_store_number" class="mt-4" />
                <Input
                    id="store"
                    type="text"
                    class="w-full mt-2"
        ...
        >
            ...
            <div class="flex items-center justify-between mb-6 gap-4">
                ...
                <div class="flex justify-end gap-3">
                    <form :action="route('shipments.pdf.statement')" method="post">
                    <input
                        type="hidden"
                        name="_token"
                ...
                <form :action="route('shipments.exel.statement')" method="post">
                        ...
                        <div class="mt-8">
                            <p class="font-bold">
                                {{ language.total_payment_upon_receipt }} ({{
                                    language.cash
                                }}): {{ sum_cash }} {{ language.riyal }}
                            </p>
                            <p class="font-bold">
                                {{ language.total_payment_upon_receipt }} ({{
                                    language.network
                                }}): {{ sum_epayment }} {{ language.riyal }}
                            </p>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.form.get(this.route("shipments.getStatement"), {
                preserveScroll: true,
