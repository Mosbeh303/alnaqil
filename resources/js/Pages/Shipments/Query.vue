<template>
  <Head :title="language.Shipment_inquiry" />

  <div>
    <page-header>{{ language.Shipment_inquiry }} </page-header>
  ...
  <span class="flex items-center">
    ...
    <span class="flex px-3 font-bold text-gray-600">
      ...
      {{ shipments.total }}
        ...
        <form :action="route('shipments.pdf.query')" method="post" id="form">
              ...
              <table class="min-w-full">
                <thead class="border-b bg-gray-100 text-sm">
                  <tr class="whitespace-nowrap">
                    ...
                    <th class="pb-4 pt-6 px-6">{{ language.mobile_number_ }}</th>
    ...
    form: {
      ...
      handler: throttle(function () {
        if (this.form.search.length === 10) {
          ...
          this.form.post(this.route("shipments.getQuery"), {
            preserveScroll: true,
