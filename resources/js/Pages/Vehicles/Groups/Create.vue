<template>
  <div>
    <Head :title="language.adding_new_car_group" />


    <page-header>
      <div class="flex justify-between">
        <div>
          {{ language.adding_new_car_group }}
        </div>
        <div>
          <BackButton/>
        </div>
    ...
    >
      <Section :title="language.add_a_group" class="h-fit">
        <Input
          id="name"
          type="text"
          v-model="form.name"
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.form.post(this.route("vehicles.groups.store"), {
        preserveScroll: true,
