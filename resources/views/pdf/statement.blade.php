...
<head>
    <meta charset="utf-8" />
    <title>كشف الشحنات المحاسبي</title>
    ...
    <div class="container">
        <div style=" min-width: 100%">
            ...
            <div style="text-align:center">
                <h2 class="font-weight: normal">كشف الشحنات المحاسبي</h2>
            </div>
        </div>
        ...
        <div style="margin-top: 10px">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        @if($shipment['payment_method'] == 'epayment') شبكة
                        @elseif($shipment['payment_method'] == 'cash') كاش
                        @endif
                    </td>
        ...
        <div style="margin-top: 40px">
            ...
            <div style="width: 49%; float: left; text-align: center">
                <table style="width: 100%">
                    ...
                    <tr class="mb-4">
                        <td class="label">اجمالي الدفع عند الاستلام (كاش)</td>
                        <td>{{ $sum['cod_cash']}} ريال</td>
                    </tr>

                    <tr class="mb-4">
                        <td class="label">اجمالي الدفع عند الاستلام (شبكة)</td>
                        <td>{{ $sum['cod_epayment']}} ريال</td>
                    </tr>
