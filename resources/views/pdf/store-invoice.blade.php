    ...
    <div class="container">
            ...
            <div class="top-table" style="width: fit-content; float: left">
                <table class="w-full border border-collapse border-slate-700">
                    ...
                    <tr>
                        ...
                        <td class="py-1 pl-12 pr-2 border border-slate-600">311251521800003</td>
                    </tr>
                </table>
            </div>
        </header>
            ...
            <div style="width: 49%; float: right">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td class="py-1 pl-12 pr-2 border border-slate-600 ">{{$store['name']}}</td>
                    </tr>
                    <tr>
        ...
        <div style="margin-top: 10px">
            ...
            <table>
                ...
                @php
                $tax = $shipment['fees'] - $shipment['fees'] / ((float)getSettingValue('vat') * 0.01 + 1);
                @endphp
                <tr>
                    <td>{{$shipment['number']}}</td>
                    <td>{{$shipment['shipping_date']}}</td>
                    <td>{{number_format($shipment['fees'] - $tax, 2)}}</td>
                    <td>15%</td>
